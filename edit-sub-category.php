...
if(isset($_POST['submit'])){
              ...
              $insert_query = "UPDATE `tblsubcategory` SET `subcat_name`='$sub_name' WHERE id='$id'";
              $insert_result = mysqli_query($conn,$insert_query);
            
              if ($insert_result) {
                // If the insertion was successful, display a success message
                $alert_type = "seagreen";
                $alert_message = "Category '$sub_name' successfully Updated.";
                echo "<script>window.location.href = 'edit-sub-category?alert_type=seagreen&&alert_message=Category Updated Succesfully';</script>";

              } else {
                // If the insertion failed, display an error message
                $alert_type = "blush";
                $alert_message = "Error: Failed to update '$sub_name'!!";
                echo '<script>window.location.href = "edit-sub-category?alert_type=seagreen&&alert_message=Category Updated Failed";</script>';
              }
    }
                        ...
                        <div class="body">
                             <form  method="post" action="">
                                        <div class="col-lg-6 col-md-12 my-2">
                                            ...
                                            <input type="text" name="category" value="<?php echo $_POST['category'];?>" class="form-control" disabled required>
                                            <input type="hidden" name="catid" value="<?php echo $_POST['id'];?>" class="form-control"  >
                                        </div>
                                        <div class="col-lg-6 col-md-12 my-2">
                                            <label>Sub Category Name</label>
                                            <input type="text" name="subcategory"  value="<?php echo $_POST['sub-category'];?>" class="form-control" required>
                                        </div>
                                <div class="col-lg-6 col-md-12 my-2">
