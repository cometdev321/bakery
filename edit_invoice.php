...
<script>
    ...
    function addRow() {
        ...
        const newRowContent =
            ...
            '<td>' +
            '  <select style="width:200px" name="itemname[]" class="form-control show-tick ms select2" id="select_products-' + rowCount + '" data-placeholder="Select" onchange="update_price(this.options[this.selectedIndex].dataset.price,' + rowCount + '),clear_product_error(' + rowCount + ')">' +
...
function create_sales_invoice() {
 ...
 function clear_product_error(val) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
         rowCount=parseFloat(document.getElementById('count_slno').value)+1;
                        ...
                        <div class="body">
                            ...
                            <div class="body table-responsive">
                                <table class="table table-bordered  table-striped table-hover" cellspacing="0">
                                    ...
                                    <?php
                                        $slno=1;
                                        $get_p = mysqli_query($conn, "SELECT * FROM tblsalesinvoice_details where sales_invoice_number='$id_no'");
                                        while($product = mysqli_fetch_array($get_p)){
                                        ?>
                                        <tr>
                                            <td><input type="text" id="<?php echo $slno; ?>" name="slno[]" class="form-control" value="<?php echo $slno; ?>" readonly></td>
                                            <td><select style="width:200px" name="itemname[]" class="form-control show-tick ms select2" id="select_products-<?php echo $slno; ?>" data-placeholder="Select" onchange="update_price(this.options[this.selectedIndex].dataset.price,<?php echo $slno; ?>),clear_product_error(<?php echo $slno; ?>)">
                                                   <option value="null"><?php echo $product['ItemName']; ?></option>
                                                 </select>
                                        <small id="product_errorMessage-<?php echo $slno; ?>" class="text-danger" style="display: none;">Select Product</small></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="hsn-<?php echo $slno; ?>" value="<?php echo $product['HSN']; ?>"name="hsn[]"></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="batchno-<?php echo $slno; ?>" value="<?php echo $product['BatchNo']; ?>" name="batchno[]"></td>
                                            <td><input type="date" style="width:150px" class="form-control" id="expiredate-<?php echo $slno; ?>" value="<?php echo $product['ExpireDate']; ?>" name="expiredate[]"></td>
                                            <td><input type="date" style="width:150px" class="form-control" id="mafdate-<?php echo $slno; ?>" value="<?php echo $product['ManufactureDate']; ?>" name="mafdate[]"></td>
                                            <td><input type="number" style="width:100px" class="form-control" id="qty-<?php echo $slno; ?>" value="<?php echo $product['Qty']; ?>" name="qty[]" onkeyup="update_amount(<?php echo $slno; ?>)" required></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="price-<?php echo $slno; ?>" name="price[]" value="<?php echo $product['Price']; ?>" onkeyup="update_amount(<?php echo $slno; ?>)" required></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="discount-<?php echo $slno; ?>" name="discount[]" value="<?php echo $product['Discount']; ?>" onkeyup="update_amount(<?php echo $slno; ?>)" required></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="tax-<?php echo $slno; ?>" name="tax[]" value="<?php echo $product['Tax']; ?>" onkeyup="update_amount(<?php echo $slno; ?>)" required></td>
                                            <td><input type="text" style="width:100px" class="form-control" id="amount-<?php echo $slno; ?>" name="amount[]" value="<?php echo $product['Amount']; ?>" readonly></td>
                                            <td>
                                            <input type="text" id="count_slno" value="<?php echo $slno; ?>" hidden readonly>
                                                
                                                <button type="button" onclick="deleteRow(<?php echo $slno; ?>)" class="btn btn-danger"><i class="icon-trash"></i></button></td>
                                        </tr>
                                        <?php
                                        echo "<script>
                                        getproducts($slno);
                        ...
                        <div class="body">
                                 <div class="row clearfix">
                                    ...
                                    <div class="row clearfix" style="float: right;">
                                      <button type="button" class="btn btn-success mx-2" onclick="create_sales_invoice()" disabled>
