...
if(isset($_POST['submit'])){
         ...
         $location    =     $_POST["location"];
             ...
             if ($insert_result) {
            echo"<script>window.location.href='mybranches?status=updated'</script>";
            } else {
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        <div class="body">
                            <?php
                                $id=$_POST['branchid'];
                                $mybranch=mysqli_query($conn,"Select * from branch where id=$id");
                                $branchdetails=mysqli_fetch_array($mybranch);
                            ?>
                             <form  method="post" action="">
                                <div class="form-group">
                                    <label>Branch Name</label>
                                    <input type="text" class="form-control" value="<?php echo $branchdetails['name'];?>" name="branchname" required>
                    ...
                    <div class="card">
						...
						<div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <?php
                                    $slno=1;
                                    $query = "SELECT * FROM branch WHERE status = '1' order by id desc";
...
if (h2 && h2.textContent.trim() === "Ajax request finished!") {
  ...
  successDiv.className = "sa-icon sa-success";
