    ...
    ?>
        <?php while ($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><?php echo date("d F Y", strtotime($row['purchase_invoice_date'])); ?></td>
                ...
                <td>
                    <div class="row">
                    <button type="button" class="btn btn-outline-primary btn-sm mx-1"  data-toggle="tooltip" data-placement="top" title="View Pos Invoice"  onclick="submitPurchasePosForm('<?php echo $row['id']; ?>')"><i class="icon-doc"></i></button>
