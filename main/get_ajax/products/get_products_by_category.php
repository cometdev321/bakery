...
$get_p = mysqli_query($conn, "SELECT productname, GROUP_CONCAT(DISTINCT size) AS sizes, saleprice, purchaseprice
FROM tblproducts where status='1' and category='$category'
