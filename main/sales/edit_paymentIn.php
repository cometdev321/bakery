              ...
              <form action="" method="post">
                <div class="body">
                  <div class="row clearfix">
                    ...
                    <div class="col-lg-6">
                      <div class="row">
                        <div class="col-md-12 my-2">
                          ...
                          <input type="number" name="paymentIN_number" id="paymentIN_number" value="<?php echo $row['paymentInNumber']; ?>" class="form-control" readonly>
                        </div>
                        <div class="col-md-12 my-2">
                    ...
                    <button type="button" class="btn btn-success mx-2" onclick="check_salesIn()">
...
<script>
 ...
 function clear_product_error(val) {
    ...
    function check_salesIn() {
        var salesInId = document.getElementById("salesInId").value;
          ...
          $.ajax({
            url: 'functions/update_paymentIN.php',
            method: 'POST',
            data: data,
             success: function(response) {
