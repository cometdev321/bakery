        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> New Products</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Manage Details<small>Approve and Reject your products here</small> </h2>                            
                        </div>
                        <div class="body">
						<div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <?php
                                    $slno=1;
                                    $query = "SELECT * FROM tblproducts WHERE status = 'requested' order by id desc";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="product_approve" value="<?php echo $row['id'];?>" hidden>
                                            <button type="submit" class="btn btn-success btn-sm "><i class="icon-like"></i><span></span></button>
                                            </form>
                                        </td>
                                        <td>
                                            <form action="remove_item" method="post">
                                            <input name="product_reject" value="<?php echo $row['id'];?>" hidden>
